...
Welcome to `TreeHole` contributor's guide.
...
If you experience bugs or general issues with `TreeHole`, please have a look
...
You can help improve `TreeHole` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`TreeHole` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `TreeHole`'s files. While this mechanism can
...
```
conda create -n TreeHole python=3 six virtualenv pytest pytest-cov
conda activate TreeHole
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/TreeHole.git
   cd TreeHole
   ```
...
5. Install [pre-commit]:
   ...
   `TreeHole` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/TreeHole
[issue tracker]: https://github.com/<USERNAME>/TreeHole/issues
